        ...
        void OnGUI()
        {
            switch (TourStep)
            {
                ...
                case 2: // create new game
                    ...
                    {
                        GUILayout.BeginHorizontal();
                        EditorGUILayout.HelpBox("PLEASE NOTICE: If you want to validate your Android in-app purchase please enter your Google Play License key (public key). Opened here to learn more about the Google Play License key.", MessageType.Info);
            ...
            switch (step)
            {
                case 1:
                    return new StringWithType[] {
                        ...
                        new StringWithType {
                            Text = "Opened here to learn more about the Game and Secret keys.",
                ...
                case 2:
                    return new StringWithType[] {
                        ...
                        new StringWithType { Text = "" },
                        new StringWithType {
                            Text = "Opened here to learn more about the full list of core metrics and dimensions.",
                            Type = StringType.Link,
                ...
                case 4:
                    return new StringWithType[] {
                        ...
                        new StringWithType { Text = "" },
                        new StringWithType {
                            Text = "Opened here to learn more about the Business event and purchase validation.",
                            Type = StringType.Link,
                ...
                case 5:
                    return new StringWithType[] {
                        ...
                        new StringWithType { Text = "" },
                        new StringWithType {
                            Text = "Opened here to learn more about the Resource event.",
                            Type = StringType.Link,
                ...
                case 6:
                    return new StringWithType[] {
                        ...
                        new StringWithType { Text = "" },
                        new StringWithType {
                            Text = "Opened here to learn more about the Progression event.",
                            Type = StringType.Link,
                ...
                case 7:
                    return new StringWithType[] {
                        ...
                        new StringWithType { Text = "" },
                        new StringWithType {
                            Text = "Opened here to learn more about the Design event.",
                            Type = StringType.Link,
                ...
                case 8:
                    return new StringWithType[] {
                        ...
                        new StringWithType { Text = "" },
                        new StringWithType {
                            Text = "Opened here to learn more about the Error event.",
                            Type = StringType.Link,
                ...
                case 9:
                    return new StringWithType[] {
                        ...
                        new StringWithType { Text = "" },
                        new StringWithType {
                            Text = "Opened here to learn more about Custom Dimensions.",
                            Type = StringType.Link,
                ...
                case 10:
                    ...
                    new StringWithType {
                    Text = "Opened here to check online documentation!",
                    Type = StringType.Link,
