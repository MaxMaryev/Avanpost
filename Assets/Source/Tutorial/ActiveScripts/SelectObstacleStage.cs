...
public class SelectObstacleStage : HiglightingUIStage
{
    ...
    private IEnumerator WaitOneFrame()
    {
        ...
        _handClickView.transform.SetParent(_obstaclesSubmenu.BuildingSlotButtons[0].transform, false);
        _uIOutline.transform.SetParent(_obstaclesSubmenu.BuildingSlotButtons[0].transform, false);
        ...
        yield return new WaitForEndOfFrame();
        _obstaclesSubmenu.BuildingSlotButtons[0].Selected += OnButtonSelected;
    }
